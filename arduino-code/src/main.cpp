...
const int redLedPin = 10;   // Digital pin 10 for red LED
const int yellowLedPin = 9; // Digital pin 9 for yellow LED
const int greenLedPin = 8;  // Digital pin 8 for green LED
